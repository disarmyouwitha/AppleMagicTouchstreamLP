...
enum GlassToKeyDefaultsKeys {
    ...
    static let fiveFingerSwipeLeftAction = "GlassToKey.fiveFingerSwipeLeftAction"
    static let fiveFingerSwipeRightAction = "GlassToKey.fiveFingerSwipeRightAction"
    static let twoFingerHoldAction = "GlassToKey.twoFingerHoldAction"
    static let threeFingerHoldAction = "GlassToKey.threeFingerHoldAction"
    static let fourFingerHoldAction = "GlassToKey.fourFingerHoldAction"
    static let outerCornersAction = "GlassToKey.outerCornersAction"
    static let innerCornersAction = "GlassToKey.innerCornersAction"
}
