...
- *If you use an open source driver, you may need to change the device read type*
  
- *I have hacked pressure data into the PTP_REPORT for the open source driver DLLs under `artifacts/DLLs` as an experiment. I hope to enable Haptics via this route but I have had **NO** luck.*
