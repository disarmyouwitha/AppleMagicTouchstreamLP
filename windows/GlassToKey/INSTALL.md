...
- ^The Official Apple driver is considered first-class by default, however, any Opensource driver based off of `imbushuo/mac-precision-touchpad` should work! (Force settings are the only thing not supported on Opensource)
