...
internal sealed class StatusTrayController : IDisposable
{
        ...
        Action exitApplication)
    {
        ...
        {
            Text = "GlassToKey Status App (Unknown)",
            Icon = _iconUnknown,
            Visible = true,
    ...
    public void SetModeIndicator(RuntimeModeIndicator mode)
    {
        ...
        {
            RuntimeModeIndicator.Mouse => "GlassToKey Status App (Mouse)",
            RuntimeModeIndicator.Mixed => "GlassToKey Status App (Mixed)",
            RuntimeModeIndicator.Keyboard => "GlassToKey Status App (Keyboard)",
            RuntimeModeIndicator.LayerActive => "GlassToKey Status App (Layer Active)",
            _ => "GlassToKey Status App (Unknown)"
        };
    }
