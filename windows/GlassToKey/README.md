...
```powershell
dotnet run --project GlassToKey/GlassToKey.csproj -c Release -- --capture .\touch-session.atpcap --metrics-out .\live-metrics.json --replay-trace-out .\capture-trace.json
```
...
```powershell
dotnet run --project GlassToKey/GlassToKey.csproj -c Release -- --replay .\touch-session.atpcap --metrics-out .\replay-metrics.json --replay-trace-out .\replay-trace.json
```
...
```powershell
dotnet run --project GlassToKey/GlassToKey.csproj -c Release -- --replay .\touch-session.atpcap --replay-ui --replay-speed 1
```
...
- Capture: `GlassToKey/fixtures/replay/smoke.atpcap`
- Fixture: `GlassToKey/fixtures/replay/smoke.fixture.json`
- Run:
  - `dotnet run --project GlassToKey/GlassToKey.csproj -c Release -- --replay GlassToKey/fixtures/replay/smoke.atpcap --fixture GlassToKey/fixtures/replay/smoke.fixture.json`
