...
- I can see when I type that we remain in TypingCommited status instead of going back to idle. Can you make sure the State logic matches _upstream_glasstokey
- Custom buttons
...
## FUTURE 
- Make clean PR to Vito's repo to add Pressure (so we can use it in our program)