...
public static class GestureBindingCatalog
{
    ...
    [
        ...
        new GestureSectionDefinition("corners", "Corner Swipes", false),
    ...
    [
        ...
        new GestureBindingDefinition("left_edge_up", "edges", "Left Up", "None"),
        new GestureBindingDefinition("left_edge_down", "edges", "Left Down", "None"),
        new GestureBindingDefinition("right_edge_up", "edges", "Right Up", "None"),
        new GestureBindingDefinition("right_edge_down", "edges", "Right Down", "None"),
        new GestureBindingDefinition("top_edge_left", "edges", "Top Left", "None"),
        new GestureBindingDefinition("top_edge_right", "edges", "Top Right", "None"),
        new GestureBindingDefinition("bottom_edge_left", "edges", "Bottom Left", "None"),
        new GestureBindingDefinition("bottom_edge_right", "edges", "Bottom Right", "None"),
        ...
        new GestureBindingDefinition("top_left_corner_swipe", "corners", "Top Left Swipe", "None"),
        new GestureBindingDefinition("top_right_corner_swipe", "corners", "Top Right Swipe", "None"),
        new GestureBindingDefinition("bottom_left_corner_swipe", "corners", "Bottom Left Swipe", "None"),
        new GestureBindingDefinition("bottom_right_corner_swipe", "corners", "Bottom Right Swipe", "None"),
