...
public static class RuntimeConfigurationFactory
{
    ...
    internal static TouchProcessorConfig BuildTouchConfig(UserSettings settings)
    {
        return TouchProcessorConfig.Default with
        {
            ...
            TopLeftCornerSwipeAction = settings.TopLeftCornerSwipeAction,
            TopRightCornerSwipeAction = settings.TopRightCornerSwipeAction,
            BottomLeftCornerSwipeAction = settings.BottomLeftCornerSwipeAction,
            BottomRightCornerSwipeAction = settings.BottomRightCornerSwipeAction,
            ...
            TopLeftForceClickAction = settings.TopLeftForceClickAction,
