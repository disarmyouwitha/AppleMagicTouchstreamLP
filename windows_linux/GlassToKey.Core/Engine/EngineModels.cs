...
internal readonly record struct TouchProcessorConfig(
    ...
    string TopLeftForceClickAction,
    string TopRightForceClickAction,
    string BottomLeftForceClickAction,
    string BottomRightForceClickAction,
    ...
    IReadOnlyDictionary<string, int>? GestureRepeatCadenceMsById)
{
    public static TouchProcessorConfig Default => new(
        ...
        TopLeftForceClickAction: "None",
        TopRightForceClickAction: "None",
        BottomLeftForceClickAction: "None",
        BottomRightForceClickAction: "None",
