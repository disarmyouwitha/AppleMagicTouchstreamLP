## Current:
- What other actions could we add?? User says, "Primary/ Hold action: separate modifiers between left and right, international keyboards usually use alt gr (right alt) to get international keys, for example: ñ is r_alt+n on the english international keyboard" Please run your ideas by me before we begin implementation!
